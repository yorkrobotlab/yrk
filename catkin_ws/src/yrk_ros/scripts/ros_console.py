...
"""
.. module:: ros_console
   :synopsis: A curses terminal-based console allowing hardware control using ROS
...
This version interacts with the robot using its ROS services.
...
def power_status_callback(power_data):
    ...
    power_box.addstr(1,16,"%1.2fV" % power_data.v_pi,curses.A_BOLD);
    power_box.addstr(1,27,"%1.2fV" % power_data.v_aux,curses.A_BOLD);
    power_box.addstr(1,38,"%1.2fA" % power_data.i_pi,curses.A_BOLD);
    power_box.addstr(1,49,"%1.2fA" % power_data.i_aux,curses.A_BOLD);
