...
def say_ip():
    ...
    ip_string = IP.decode()
    play_audio_file("wav/ip_address.wav")
    for char in ip_string:
        if char == '1': play_audio_file("wav/1.wav")
        elif char == '2': play_audio_file("wav/2.wav")
        elif char == '3': play_audio_file("wav/3.wav")
        elif char == '4': play_audio_file("wav/4.wav")
        elif char == '5': play_audio_file("wav/5.wav")
        elif char == '6': play_audio_file("wav/6.wav")
        elif char == '7': play_audio_file("wav/7.wav")
        elif char == '8': play_audio_file("wav/8.wav")
        elif char == '9': play_audio_file("wav/9.wav")
        elif char == '0': play_audio_file("wav/0.wav")
        elif char == '.': play_audio_file("wav/dot.wav")
    return IP.decode()
...
if __name__ == "__main__":
 ...
 setup_audio()
 play_audio_file("wav/york-robotics-kit.wav")
 time.sleep(1.2)
 say_ip()
 time.sleep(10)
 kill_audio()
